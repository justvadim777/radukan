...
const products = [
  {
    ...
    cta: "Подробнее",
    icon: (
      <svg className="w-10 h-10 text-gold opacity-80" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
...
export function ProductsSection() {
  return (
    <AnimatedSection className="px-[60px] py-[100px] max-md:px-5 max-md:py-[60px]">
      <div className="section-label">Продукты</div>
      <h2
        className="font-heading font-bold uppercase tracking-[1px] mb-14"
        style={{ fontSize: "clamp(28px, 4vw, 42px)" }}
      >
        Экосистема <span className="text-gold">Raducan</span>
      </h2>
