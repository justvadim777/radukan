...
const contentRu = {
  ...
  roi: {
    title: "Калькулятор окупаемости кальянной",
    description: "Рассчитайте окупаемость вашего заведения.",
  ...
  dca: {
    title: "Калькулятор регулярных инвестиций",
  ...
  crm: {
    title: "Чек-лист выбора системы учёта клиентов",
    description: "Отметьте функции, которые вам нужны.",
    selectedLabel: "Выбрано:",
    coverageMessage: "Готов помочь с подбором и внедрением системы учёта клиентов под ваши задачи",
